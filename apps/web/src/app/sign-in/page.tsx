import { Logo, ErrorIcon, Label, Button } from "@beacon/ui";
import Link from "next/link";
import GoogleOAuthSignInButton from "~/components/googleOAuthSignInButton";
        ...
        {error === "access_denied" ? (
          <div className="my-2 flex select-none flex-col gap-2 rounded-xl border border-gray-200 bg-gray-100 py-4 px-6 text-gray-800 hover:bg-gray-200 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200 dark:hover:bg-gray-700">
            ...
            <p className="text-base text-gray-600 dark:text-gray-400">
              ...
              Beacon, please sign up for the{" "}
              <Link href="/" className="underline underline-offset-4">
                waitlist
              </Link>
              . We will send you an invite asap.
            </p>
          </div>
        ) : null}
        <SignInForm />
