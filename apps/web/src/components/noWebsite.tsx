...
></script>`;
  ...
  return (
    <div className="grid h-full w-full place-items-center overflow-hidden py-6 md:py-0">
      <div className="flex max-w-lg flex-col items-center gap-6 px-6 text-center text-gray-800 md:p-0">
        ...
        <div className="relative rounded-2xl bg-gray-900 p-4 text-left font-mono text-sm text-gray-100 selection:bg-primary-900 md:w-full md:text-base">
